module.exports = nativeDescription: "日本語", englishDescription: "Japanese", translation:
  new_home:
    ...
    forgot_learning: "私が思うに、彼らは学んでいるという事を忘れているのだと思います。"
    wanted_to_do: " コーディングとは常に自分で学ぶものであり、決して学校で習う事ができる事だとは思った事はありませんん。"
    why_games: "ゲームを通じて学ぶ事はなぜ大切なのですか？"
    games_reward: "ゲームは生産性の問題を解決してくれます。"
    encourage: "ゲームで遊ぶ事は物事に関わったり、発見したり、試行錯誤をする動機づけとなります。良いゲームを遊び続ける事で、学生が一つ一つを積み重ねて何かを学んでゆく様に、プレイヤーは技能を習得する事ができます。 "
    excel: "ゲームはやりがいという面で優れています。"
    struggle: "生産性の問題"
...
#    want_coco: "Want CodeCombat at your school?"
  ...
  signup:
    ...
    facebook_exists: "そのFacebookアカウントではすでに登録済みです！"
    hey_students: "学生の皆さん、先生から与えられたクラス番号を入力して下さい。"
    birthday: "誕生日"
    parent_email_blurb: "すぐにプログラミングを学び始めたいですよね。 &mdash; 私たちもそうです。お父さんかお母さんに宛にあなたのアカウントを登録するために必要な手順を書いたお送りしました。メールが届かないなどの問題があれば、{{email_link}} にメールでご連絡下さい。"
    classroom_not_found: "そのクラス番号は無効です。もう一度クラス番号を確認し入力し直すか、先生に聞いてみてください。"
    checking: "確認中です..."
    account_exists: "そのメールアドレスは既に登録済みです:"
    sign_in: "サインイン"
    email_good: "メールアドレスは正しい様です！"
    name_taken: "そのユーザー名は、すでに他のユーザーが使用しています。！{{suggestedName}}というユーザー名なら使用できますよ？"
    name_available: "このユーザー名で登録可能です！"
